...
<html class="no-js" lang="zxx">
    ...
    <body>
        <?php #$this->session->flashdata('preloader') ? $this->load->view('ecommerce/preloader') : ''; ?>
        ...
        <?php #$this->load->view('ecommerce/hero-slider'); ?>
        <?php $this->load->view('ecommerce/banner'); ?>
        <?php $this->load->view('ecommerce/products'); ?>
        <?php $this->load->view('ecommerce/new-arrival'); ?>
        <?php $this->load->view('ecommerce/hot-deal'); ?>
        <?php $this->load->view('ecommerce/featured'); ?>
        <?php #$this->load->view('ecommerce/brands'); ?>
