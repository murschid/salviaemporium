                ...
                <div class="col-md-6">
                    <div class="card card-info">
                        <div class="card-body mycards">
                            ...
                            <div class="form-group">
                                <label>Hot Deal Date <span class="text-red">*</span></label>
                                <input type="date" name="hotdealdate" min="<?= date('Y/m/d'); ?>" class="form-control" required="" placeholder="2021/12/30">
                            </div>
                            <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="card card-info">
                        <div class="card-body mycards">
                            ...
                            <input type="hidden" name="hotdealyn" value="1">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Hot Deal Image <span class="text-red">* [1 image & size will be 460x400]</span></label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" name="hotdeal" class="custom-file-input" required="">
                                        <label class="custom-file-label">Choose Images</label>
                                    </div>
                                </div>
                            </div>
